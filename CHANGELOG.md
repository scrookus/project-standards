...
- Added a preferred worktree layout order: sibling directories first, a documented parent next to a bare repo second, and nested in-repo worktrees only as explicit local exceptions.
